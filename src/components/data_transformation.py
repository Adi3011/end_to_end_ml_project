...
class DataTransformation:
    ...
    def get_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"Standard scaling for numerical columns encoding completed: {numerical_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info(f"Applying preprocessing obj on training df and testing df.")
